...
def build_features(sentences, train, dico_lemm, dico_bigram, dico_trigram, dico_pattern, bioscope, globalMeasure, localMeasure, bool_f_selection):
	...
	file_in_w = open(training_file, "r",encoding = "utf8").readlines()	
...
def MUD(globalMeasure, localMeasure, bool_f_selection = 1):
	...
	file_in = open("Data/Features/lemm_probability_binomial.txt",encoding = "utf8").readlines()
	dico_lemm = read_file_8col_round(file_in, 5)

	file_in = open("Data/Features/bigram_probability_binomial.txt",encoding = "utf8").readlines()
	dico_bigram = read_file_8col_round(file_in, 5)

	file_in = open("Data/Features/trigram_probability_binomial.txt",encoding = "utf8").readlines()
	...
	if bioscope == 0:
		file_in = open("Data/WikiWeasel/lemm_pos_chunk_dep_wiki_train.txt", "r",encoding = "utf8").readlines()
	elif bioscope == 1:
		file_in = open("Data/BioScope/bioscope_train.txt", "r",encoding = "utf8").readlines()
	else:
		file_in = open("Data/SFU/SFU_train_annot.txt", "r",encoding = "utf8").readlines()
	...
	#tvect = TfidfVectorizer(min_df=1, max_df=6)
	#X_test=tvect.transform(features)
