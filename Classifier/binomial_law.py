...
def binomial_law(pu, sw, suw, coef_binomial_calculs, factorial_calculs):
	...
	for i_suw in range(suw, (sw+1)):
		...
		new_coef = 0
		if sw in coef_binomial_calculs:
			if i_suw in coef_binomial_calculs[sw]:
